...
vagrant ssh server1 -c "sudo gluster volume create $1 disperse-data 2 redundancy 1 server1:/gluster/brick1/brick server2:/gluster/brick1/brick server3:/gluster/brick1/brick"
